...
CFLG=-O3 -Wall -Wno-deprecated-declarations -DRES=$(RES) -Iinclude -I/opt/homebrew/Cellar/freetype/2.13.3/include/freetype2/
LIBS=-framework GLUT -framework OpenGL -L/opt/homebrew/Cellar/freetype/2.13.3/lib -lfreetype
# Linux/Unix/Solaris
else
